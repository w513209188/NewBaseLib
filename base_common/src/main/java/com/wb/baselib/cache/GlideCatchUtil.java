...
public class GlideCatchUtil {
    ...
    public String getCacheSize() {
        try {
            return getFormatSize(getFolderSize(new File(mContext.getCacheDir() + "/" + BaseAppConfig.GLIDE_PATH)));
        } catch (Exception e) {
            e.printStackTrace();
            return "获取失败";
        }
    ...
    public boolean cleanCatchDisk() {
        return deleteFolderFile(mContext.getCacheDir() + "/" + BaseAppConfig.GLIDE_PATH, true);
    }
